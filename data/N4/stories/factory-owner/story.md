...
### Vocabulary Used (from N4 Lessons 35–36)

**N4.35 – Owners, Stopping & Washing**
...
- 動く (うごく) - to move (N4.16)
- 工場 (こうじょう) - factory (N4.33)
- 建物 (たてもの) - building (N4.33)
- 食堂 (しょくどう) - cafeteria (N4.31)
- 食事 (しょくじ) - meal (N4.14)
- 仕事 (しごと) - work / job (N4.14)
- 地区 (ちく) - district (N4.34)
- 通う (かよう) - to commute (N4.34)
- 計画 (けいかく) - plan (N4.29)
...
- 田中 (たなか) - Tanaka (N4.17)
- 自分 (じぶん) - oneself (N4.10)
- 始める (はじめる) - to start (N4.9)
- 人々 (ひとびと) - people (N5)
- 大切 (たいせつ) - important (N5)
- うれしい - happy / glad (N5)
- 早い (はやい) - early (N4.14)
- 新しい (あたらしい) - new (N5)
- 高い (たかい) - high / expensive (N5)
- 少ない (すくない) - few / scarce (N5)

### Grammar Points Used

- Past tense (ました、でした)
- Plain past (始めた、高かった)
- Te-form (止まって、考えて、作って)
