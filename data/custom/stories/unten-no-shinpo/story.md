...
けんがそこで「たろうさん、運転がかるいですよね。わたしも乗って いいですか？りょこうの時も、車で色々な所をまわりたいですね」と言った。
...
けんは後ろからまた話し始めた。「りきぞ、前のりょこうを知って いるか？バスの中でも、けんはこうして食事して いたよ。たびさき では、食べながら色々な所に行くのが 好きなんだ」
...
- りょこう (旅行) — trip / travel [written in kana: 旅 not taught]
- たびさき (旅先) — travel destination [written in kana: 旅 not taught]
- うつす (写す) — to copy / transcribe [written in kana: 写 not taught]
- かるい (軽い) — light (weight/easy) [written in kana: 軽 not taught]
- かるくち (軽口) — flippant remark [written in kana: 軽 not taught]
- ならう (習う) — to learn from a teacher [written in kana: 習 not taught]
- とおす (通す) — to let through / pass [written in kana: 通 not taught]
- まわる (回る) — to go around [written in kana: 回 not taught]
