...
今日は休みです。天気がいいです。りきぞとレンはいっしょに外に行きました。
...
りきぞは言いました。「北 東か北 西か…分からない。」

「山は北 東だよ。東に行こう。」とレンが言いました。レンは道がよく分かります。上手です。
...
「北 西に家がたくさんあるね。」とレンが言いました。

「南 西に店があるよ。花の店だね。行きたい！」とりきぞが言いました。

「南 東に小さい川もあるね。おもしろそうだ。」とレンが言いました。
...
Today is a day off. The weather is nice. Rikizo and Ren went outside together.

"Where do you want to go?" said Ren.
...
**N5.15 Vocabulary (Cardinal Directions):**
- 北 (きた) — north
- 南 (みなみ) — south
- 東 (ひがし) — east
- 西 (にし) — west
...
**N5.16 Vocabulary (Sides & Vertical):**
- 右 (みぎ) — right
- 左 (ひだり) — left
- 上 (うえ) — above / on top
- 下 (した) — below / under
...
- Polite masu (分かります, あります) — N5.5
- Polite mashita (行きました, ありました, 言いました, 来ました, 休みました) — N5.5
- Polite past adj (よかったです) — N5.10
- Plain past adj (よかった) — G9
- Te-form connector (飲んで、休みました) — G7
- Te-form progressive (休んでいます) — G8
- Plain desire tai (行きたい, 来たい) — G9
- Plain volitional (行こう, 来よう) — G9
- Plain negative (分からない) — N5.9
- Adverbial (よく) — N5.10
- Plain appearance sou (おもしろそうだ) — G9
- Attributive na (きれいな) — N5.11
- が as clause connector "but" (長い道ですが) — G9
- から as "because" (天気がいいから) — G9
- けど as "but" (下手だけど) — G9
- と as quotation marker (と言いました) — N5.13
