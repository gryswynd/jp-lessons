...
### G26 — Advanced Adjective Patterns (くなる / になる, くする / にする)
...
- ～くなければ / ～でなければ — must be ~ / if it's not ~ (adjective obligation/condition):
  ...
  - Parallels G22 verb なければいけない — the same obligation concept applied to adjective predicates
...
6. `grammarRule` — ～くなければ / ～でなければ (must be ~ — adjective obligation): parallels verb なければいけない from G22 (×1)
...
- ～くなってきた and ～になってきた: the てくる pattern is taught in G29 (Directional て-Form). This lesson introduces なってきた as a specific adjective+change combination; the full theory of てくる directional change is expanded in G29.
...
### G29 — Directional & Resultant て-Form (てくる / ていく / てある)
...
### G31 — Relative Clauses & Noun Modification
...
### G33 — Volitional Form & Intentions
...
### G34 — Conjecture & Inference (ようだ / みたいだ / らしい)
...
### G35 — Expectation & Reasoning (はずだ / わけだ)
...
### G36 — Aspect & Temporal States (ところだ / たばかり)
...
### G37 — Sentence-Ending Particles & Register
...
### G39 — Honorific & Humble Speech (敬語 Introduction)
...
### G41 — Perspective & Relation Particles
...
### G42 — Causative-Passive & Advanced Voice
...
### G43 — Suffixes & Word Formation (っぽい / がち / 気味 / ～やか)
...
### G44 — Advanced Conditionals & Wishes
...
### G46 — Compound Expressions & Set Patterns
...
### G48 — N3 Grammar Capstone Review
