#!/bin/bash
# Setup script: copies/symlinks existing art assets into the Godot project
...
cp "$DAY_SRC/convo-bg.png"  "$ASSETS_DIR/day-data/convo-bg.png"

echo "  Copying Day 01 sprites..."
cp "$DAY_SRC/sprites/mom.png"       "$ASSETS_DIR/day-data/sprites/mom.png"
cp "$DAY_SRC/sprites/mom-convo.png" "$ASSETS_DIR/day-data/sprites/mom-convo.png"
cp "$DAY_SRC/sprites/dad.png"       "$ASSETS_DIR/day-data/sprites/dad.png"
cp "$DAY_SRC/sprites/dad-convo.png" "$ASSETS_DIR/day-data/sprites/dad-convo.png"
cp "$DAY_SRC/sprites/me-convo.png"  "$ASSETS_DIR/day-data/sprites/me-convo.png"
