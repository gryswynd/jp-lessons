...
|---|---|---|
| `campaigns/n5-qa-and-game-days.md` | In Progress | Phase 1 QA near-complete (3 edge cases remain); Phase 2: build 17 game days |
| `campaigns/n4-completion.md` | Final QA | All grammar/compose/lessons built; final review QA pass in progress |
